CREATE DATABASE  IF NOT EXISTS `funkoDB` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `funkoDB`;
...
UPDATE licence SET licence_description = " Disfruta de una saga que sigue agregando personajes a su colección." WHERE licence_id = 1;
...
insert into licence (licence_name, licence_description, licence_image)
values("Pikachu","Pikachu lucha en batallas fundamentales en el anime, manga y videojuegos. No te lo pierdas!!","/img/pokemon/pikachu-1.webp")
